...
class NewSequenceFromSelectionAction(QAction):
  ...
  class NewSequenceFromSelection(QDialog):
    ...
    def __init__(self,  trackItem,  parent=None):
      ...
      self.radioSingle = QRadioButton("Single Sequence", self.groupBox)
      ...
      self.radioMultiple = QRadioButton("Multiple Sequences", self.groupBox)
      ...
      self.groupLayout.setWidget(0, QFormLayout.SpanningRole, self.radioSingle)
      self.groupLayout.setWidget(1, QFormLayout.SpanningRole, self.radioMultiple)
      ...
      self.sequenceLayers = QCheckBox("Sequential Layers", self.groupBox)
      ...
      self.groupLayout.setWidget(2, QFormLayout.FieldRole, self.sequenceLayers)

      self.includeAudio = QCheckBox("Include Audio", self.groupBox)
      ...
      self.groupLayout.setWidget(3, QFormLayout.SpanningRole, self.includeAudio)

      self.useTimecode = QCheckBox("Use Timecode", self.groupBox)
      ...
      self.groupLayout.setWidget(4, QFormLayout.SpanningRole, self.useTimecode)

      self.timecodeHorizontalLayout = QHBoxLayout()
      self.timecodeHorizontalLayout.setSpacing(-1)
      self.timecodeHorizontalLayout.setSizeConstraint(QLayout.SetDefaultConstraint)
      self.timecodeHorizontalLayout.setObjectName("timecodeHorizontalLayout")

      self.TCspacerItem = QSpacerItem(15, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
      self.groupLayout.setItem(5, QFormLayout.LabelRole, self.TCspacerItem)

      self.timecodeOptionsLabel = QLabel()
      ...
      self.timecodeOptions = QComboBox()
      ...
      self.groupLayout.setWidget(5, QFormLayout.SpanningRole, self.timecodeOptions)
      ...
      self.groupLayout.setLayout(5, QFormLayout.SpanningRole, self.timecodeHorizontalLayout)

      self.dividerline1 = QFrame()
      self.dividerline1.setFrameShape(QFrame.HLine)
      self.dividerline1.setFrameShadow(QFrame.Sunken)
      self.groupLayout.setWidget(6, QFormLayout.SpanningRole, self.dividerline1)
      ...
      self.groupLayout.setLayout(7, QFormLayout.SpanningRole, self.horizontalLayout)

      self.horizontalLayout2 = QHBoxLayout()
      self.horizontalLayout2.setSpacing(-1)
      self.horizontalLayout2.setSizeConstraint(QLayout.SetDefaultConstraint)
      ...
      self.spacerItem2 = QSpacerItem(175, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
      self.horizontalLayout2.addItem(self.spacerItem2)
      self.groupLayout.setLayout(8, QFormLayout.SpanningRole, self.horizontalLayout2)

      self.dividerline2 = QFrame()
      self.dividerline2.setFrameShape(QFrame.HLine)
      self.dividerline2.setFrameShadow(QFrame.Sunken)
      self.groupLayout.setWidget(9, QFormLayout.SpanningRole, self.dividerline2)
  ...
  def __init__(self):
      QAction.__init__(self, "New Sequence from Selection", None)
  ...
  def clipInfo(self, clip, fps):
    ...
    clipInfo['clip']['framerange'] = range(start, end)
...
#                         try:
                        audioClip = newAudioTrack.addTrackItem(clip, i, start)
#                         newAudioTrack = sequence.addTrack(hiero.core.AudioTrack("Audio " + str(trackindex + i + 1) ))
#                         audioClip = newAudioTrack.addTrackItem(clip, i, start)
#                         except:
